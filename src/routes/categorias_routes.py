...
from src.controllers.categorias_controller import get_categorias, crear_categoria, agregar_categoria_a_tarea, eliminar_categoria_de_tarea, actualizar_categoria
...
def actualizar_categoria_existente(id):   
